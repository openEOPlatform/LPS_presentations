...
And finally, view the cog interactively. Currently using a custom function, a generic COG viewing will be available soon via the package `mapview`(<https://github.com/r-spatial/mapview/issues/400>)
...
Update the process graph to aggregate to monthly values.
