...
If you don't want to click through the DIY instructions, you can also simply copy the workflow instructions into the "Code" tab and run the workflow (ideally as a batch job):
...
```json
{
  "process_graph": {
    "1": {
      ...
      "description": "Monthly maximum values"
    },
    "load_collection_LUCZT2231M": {
      "process_id": "load_collection",
      "arguments": {
